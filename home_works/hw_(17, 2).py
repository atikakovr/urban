"""
2024/02/08 00:00|Домашнее задание по теме "Преобразование изображений. Цветовые форматы."
Цель задания:
...
Подготовьте
 картинку к обработке для нейросети:
...
Примечания:
Рекомендуется подобрать цветовой формат
 так, чтобы был максимальный контраст с задним фоном.
В конечном итоге нужно работать с бинарным форматом (0, 1)
, чтобы лучше определять контуры изображения.
Не забудьте найти контуры
 и окрасить каждую строку в отличным друг от друга цвета.
Допустимы небольшие погрешности
 в окрашивании контуров (как в примере: красный фрагмент на зелёном тексте)
