...
Используя геометрические примитивы из библиотеки OpenCV
, нужно отрисовать следующий рисунок:
Создайте матрицу (картинку) при помощи NumPy
 в виде квадрата произвольного размера.
Отрисуйте картинку используя примитивы circle, ellipse, line
 и др.
...
Доп. задание:
Попробуйте сделать фон - градиент (
можно цветной):
