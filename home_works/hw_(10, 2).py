...
Использовать лямбда-функцию для реализации простой операции и написать такую же функцию с использованием def. Например, возведение числа в квадрат Задача 3: Вызываемые Объекты
...
Пример вывода программы Задача 1: Фабрика функций
6
2.0
